...
N 310 -550 350 -550 { lab=vssa1}
N 310 -550 310 -460 { lab=vssa1}
N 310 -460 350 -460 { lab=vssa1}
N 280 -500 310 -500 { lab=vssa1}
N 370 -490 510 -490 { lab=#net1}
N 510 -520 510 -490 { lab=#net1}
N 510 -610 510 -580 { lab=Rout}
N 510 -610 530 -610 { lab=Rout}
N 490 -550 490 -460 { lab=vssa1}
N 350 -460 490 -460 { lab=vssa1}
...
C {devices/iopin.sym} 290 -500 2 0 {name=p4 lab=VSUB
}
C {devices/iopin.sym} 290 -430 2 0 {name=p5 lab=VGND
}
